...
<head>
  ...
  <?php print $head; ?>
  <link rel="image_src" href="http://hakaveret.org.il/sites/default/files/logo.jpg" />
  <meta property="og:title" content="הכוורת" />
  <meta property="og:description" content="<?php print $title; ?>" />
  <meta property="og:image" content="http://hakaveret.org.il/sites/default/files/logo.jpg" />
  <?php print $styles; ?>
...
<body id="<?php print $body_id; ?>" class="<?php print $body_classes; ?>">
  ...
  <div id="page" class="page">
    <div id="page-inner" class="page-inner">
      ...
      <div id="header-group-wrapper" class="header-group-wrapper full-width">
        <div id="header-group" class="header-group row <?php print $grid_width; ?>">
          <div id="header-group-inner" class="header-group-inner inner clearfix">
            ...
            <?php print custom_top_menu($search_box,$primary_links_tree); ?>
      ...
      <div id='fixedbanner'><!-- --></div>
      <div id='fixedbanner-shelet'><!-- --></div>
    </div><!-- /page-inner -->
  </div><!-- /page -->
  <?php print $closure; ?>
</body>
