...
<html xmlns="http://www.w3.org/1999/xhtml" lang="<?php print $language->language; ?>" xml:lang="<?php print $language->language; ?>">
  <head>
	...
	<script type="text/javascript">
	  function coolFN() {
	  var leftSideBar = document.getElementById("sidebar-first").offsetHeight;
	  ...
	  document.getElementById("sidebar-first").style.height = newHeight;
	  document.getElementById("content").style.height = newcenHeight;
	  }
    </script>
    
  </head>
  <body class="<?php print $body_classes; ?>" onload="coolFN()">       
    <div id="page">
      <div id="header">        
      ...
      <div id="main" <?php if (empty($content_after)) print 'class="footer-spacer"';?>>
        ...
        <div id="content">
         ...
         <div id="content-area" class="content-region">
		   ...
		   <?php if (arg(0) == 'articles'): ?>
		     <div id="left-articles">
			   <img src="/heshel/sites/default/files/chach_pic1.jpg">
			 </div>
		   <?php endif; ?>
         </div>
         <!-- /content-area -->
