...
<div class="container">
  <div id="header" class="header span-24 last">
      <?php if ($title): ?>
  ...
  <?php if ($left): ?>
    <div class="<?php //print $left_classes; ?>col-left span-5"><?php print $left; ?></div>
  <?php endif ?>

  <div class="<?php //print $center_classes; ?>col-center span-14">
    <?php
      if ($breadcrumb != '') {
        print $breadcrumb;
      }
  ...
  <?php if ($right): ?>
    <div class="<?php //print $right_classes; ?>col-right span-5 last"><?php print $right; ?></div>
  <?php endif ?>
