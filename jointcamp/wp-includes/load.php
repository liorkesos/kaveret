...
function wp_unregister_GLOBALS() {
	...
	if ( isset( $_REQUEST['GLOBALS'] ) )
		die( /*WP_I18N_GLOBALS_OVERWRITE*/'זוהה ניסיון לעקוף משתנים גלובליים'/*/WP_I18N_GLOBALS_OVERWRITE*/ );
...
function wp_check_php_mysql_versions() {
	...
	if ( version_compare( $required_php_version, $php_version, '>' ) )
		die( sprintf( /*WP_I18N_OLD_PHP*/'בשרת מותקנת גרסה %1$s של PHP, אך דרישת המינימום להפעלת וורדפרס %2$s היא גרסה %3$s או גרסה חדשה יותר.'/*/WP_I18N_OLD_PHP*/, $php_version, $wp_version, $required_php_version ) );

	if ( !extension_loaded( 'mysql' ) && !file_exists( WP_CONTENT_DIR . '/db.php' ) )
		die( /*WP_I18N_OLD_MYSQL*/'התקנת PHP אינה כוללת הרחבת MySQL אשר נדרש על ידי וורדפרס.'/*/WP_I18N_OLD_MYSQL*/ );
}
...
?>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<title><?php echo /*WP_I18N_MAINTENANCE*/'תחזוקה'/*/WP_I18N_MAINTENANCE*/; ?></title>

	</head>
	<body>
		<h1><?php echo /*WP_I18N_MAINT_MSG*/'אתר זה עובר עבודות תחזוקה יזומות. נא לנסות שנית בעוד מספר דקות.'/*/WP_I18N_MAINT_MSG*/; ?></h1>
	</body>
	</html>
<?php
	die();
...
function wp_set_wpdb_vars() {
	...
	if ( is_wp_error( $prefix ) )
		wp_die( /*WP_I18N_BAD_PREFIX*/'<strong>שגיאה</strong>: אפשר להשתמש רק באותיות, מספרים וקווים תחתונים בקידומת בסיס הנתונים (<code>$table_prefix</code>) בקובץ <code>wp-config.php</code>'/*/WP_I18N_BAD_PREFIX*/ );
}
