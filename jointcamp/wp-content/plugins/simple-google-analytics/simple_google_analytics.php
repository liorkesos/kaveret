...
*/
	...
	add_action('init', 'SGA_launch_i18n') ;

	// On lance la fonction 'sga_menu' lorsque le menu est charge
	add_action('admin_menu', 'SGA_menu') ;
	
	// On ajoute le settings dans la liste des plugins
	add_filter('plugin_action_links_'.plugin_basename(__FILE__), 'SGA_plugin_action_links') ;
	
	
	// Fonction de traduction
	function SGA_launch_i18n() {
	...
	// Ajoute un lien paramètre dans la page extensions
	function SGA_plugin_action_links($links) {
