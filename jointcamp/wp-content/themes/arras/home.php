...
<?php endif ?>
	...
	?>
	<div style="text-align: left; margin: 0px 0 35px 0;" class="read-more"><a href="http://j14.org.il/articles/category/%D7%97%D7%93%D7%A9%D7%95%D7%AA-%D7%94%D7%9B%D7%99%D7%9B%D7%A8">לכתבות נוספות</a></div>
</div>
<!-- #index-featured1 -->
<?php endif; ?>
...
<?php if(function_exists('wp_pagenavi')) wp_pagenavi(); else { ?>
	<div class="navigation clearfix">
		<div class="floatleft"><?php next_posts_link( __('פוסטים ישנים יותר', 'arras') ) ?></div>
		<div class="floatright"><?php previous_posts_link( __('פוסטים חדשים יותר', 'arras') ) ?></div>
	</div>
<?php } ?>
...
<div class="home-title"><?php _e('כתבות אחרונות', 'arras') ?></div>
