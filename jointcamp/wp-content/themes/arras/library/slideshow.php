...
function arras_add_slideshow() {
	...
	<div class="featured clearfix">
		...
		<div id="controls">
			<a href="" class="prev"><?php _e('קודם', 'arras') ?></a>
			<a href="" class="next"><?php _e('הבא', 'arras') ?></a>
		</div>
		<?php endif ?>
...
function arras_add_slideshow_thumb_size() {
	...
	arras_add_image_size( 'featured-slideshow-thumb', __('מצגת כתבות', 'arras'), $size[0], $size[1]);
}
