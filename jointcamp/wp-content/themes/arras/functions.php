...
// add extra youtube icon 
function add_extra_sociallinks() { 
            ?>
        <li><a id="youtube" title="<?php printf( __( '%s on YouTube', 'arras' ), esc_html( get_bloginfo('name'), 1 ) ) ?>" href="http://www.youtube.com/user/betzeohel" target="_blank"><?php _e('YouTube', 'arras') ?></a></li>
        <?php 
}
