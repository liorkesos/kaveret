<?php // Modified for WPH (default links)
/**
...
function wp_install_defaults($user_id) {
	...
	$default_links = array();
	$default_links[] = array(	'link_url' => 'http://docs.wph.co.il/',
								'link_name' => 'עזרה ותיעוד',
								'link_rss' => '',
								'link_notes' => '');

	$default_links[] = array(	'link_url' => 'http://he.wordpress.org/',
								'link_name' => 'וורדפרס בעברית',
								'link_rss' => 'http://he.wordpress.org/feed',
								'link_notes' => '');

	$default_links[] = array(	'link_url' => 'http://support.wph.co.il/',
								'link_name' => 'תמיכה וסיוע',
								'link_rss' => '',
								'link_notes' =>'');

	$default_links[] = array(	'link_url' => 'http://planet.wph.co.il/',
								'link_name' => 'פלאנט וורדפרס',
								'link_rss' => '',
								'link_notes' =>''); 
								// WPH - Changed all links
	...
	$first_comment_url = 'http://he.wordpress.org/'; // WPH
